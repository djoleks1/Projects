...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9tYWluLWNvbXBvbmVudC9tYWluLWNvbXBvbmVudC5jb21wb25lbnQuY3NzIn0= */"
...
module.exports = "<div class=\"row\">\r\n    <div class=\"col-md-8\">\r\n    <table class=\"table\">\r\n        <tr>\r\n        <th>Title</th>\r\n        <th>Category</th>\r\n        <th>Text</th>\r\n        <th>Akcione</th>\r\n    </tr>\r\n    <tr *ngFor=\"let a of articles\">\r\n        <td>{{a.title}}</td>\r\n        <td>{{a.category.name}}</td>\r\n        <td>{{a.text}}</td>\r\n        <td>\r\n                <button class=\"btn btn-primary\" (click)=\"editArticle(a)\">Edit</button>\r\n                <button class=\"btn btn-danger\" (click)=\"delete(a)\">Delete</button>\r\n        </td>\r\n    </tr>\r\n    </table>\r\n</div>\r\n<div class=\"col-md-4\" *ngIf=\"hasRole('ROLE_ADMIN')\">\r\n        <form class=\"form\" (ngSubmit)=\"save()\">\r\n            <div class=\"form-group\">\r\n                Select Category:\r\n                <select class=\"form-control\" name=\"category\" [compareWith]=\"byId\" [(ngModel)]=\"article.category\">\r\n                    <option *ngFor=\"let category of categories\" [ngValue]=\"category\">{{category?.name}}</option>\r\n                </select>\r\n            </div>\r\n            <div class=\"form-group\">\r\n                Title:<input name=\"title\" class=\"form-control\" [(ngModel)]=\"article.title\">\r\n            </div>\r\n            <div class=\"form-group\">\r\n                Text:<input name=\"text\" class=\"form-control\" [(ngModel)]=\"article.text\">\r\n            </div>\r\n            <input type=\"submit\" value=\"save\" class=\"btn btn-primary\">\r\n        </form>\r\n    </div>\r\n</div>"
...
var MainComponentComponent = /** @class */ (function () {
    ...
    MainComponentComponent.prototype.loadData = function () {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            ...
            .set('size', '5');
        this.http.get('api/articles', { params: params }).subscribe(function (data) {
            // this.http.get(`api/articles?page=${this.currentPage}&size=${5}`).subscribe( data => {
            _this.articles = data['content'];
    ...
    MainComponentComponent.prototype.loadCategories = function () {
        var _this = this;
        this.http.get('api/categories').subscribe(function (data) {
    ...
    MainComponentComponent.prototype.delete = function (article) {
        var _this = this;
        this.http.delete("api/articles/" + article.id).subscribe(function (data) {
            console.log(data);
            _this.loadData();
        });
    };
    ...
    //   }
    // }
    MainComponentComponent.prototype.editArticle = function (newArticle) {
    ...
    MainComponentComponent.prototype.save = function () {
        ...
        if (this.article.id != null) {
            this.http.put("api/articles/" + this.article.id, JSON.stringify(this.article), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
        else {
            this.http.post('api/articles', JSON.stringify(this.article), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
    };
...
module.exports = __webpack_require__(/*! c:\Users\User\Documents\Projekti\WebNews\projekat\client\src\main.ts */"./src/main.ts");
