...
var MainComponentComponent = /** @class */ (function () {
    ...
    MainComponentComponent.prototype.loadData = function () {
        ...
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            ...
            .set('size', '5');
        this.http.get('api/meals', { params: params }).subscribe(function (data) {
            // this.http.get(`api/computer-parts?page=${this.currentPage}&size=${5}`).subscribe( data => {
            _this.meals = data['content'];
    ...
    MainComponentComponent.prototype.save = function () {
        ...
        if (this.meal.id != null) {
            this.http.put("api/meals/" + this.meal.id, JSON.stringify(this.meal), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
        else {
            this.http.post('api/meals', JSON.stringify(this.meal), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
    };
    MainComponentComponent.prototype.delete = function (id) {
        var _this = this;
        this.http.delete("/api/meals/" + id).subscribe(function (res) {
            console.log("Obrisao" + ("" + id));
            _this.loadData();
        });
    };
    MainComponentComponent.prototype.editMeal = function (m) {
        this.meal = m;
    };
    MainComponentComponent.prototype.filterName = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
    ...
    MainComponentComponent.prototype.filterCategory = function () {
        var _this = this;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
...
module.exports = __webpack_require__(/*! C:\Users\User\Documents\Projekti\RestorantNew\projekat\client\src\main.ts */"./src/main.ts");
