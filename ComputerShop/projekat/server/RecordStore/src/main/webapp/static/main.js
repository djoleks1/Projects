...
var MainComponentComponent = /** @class */ (function () {
    ...
    MainComponentComponent.prototype.loadData = function () {
        var _this = this;
        this.http.get('api/computer-parts').subscribe(function (data) {
    ...
    MainComponentComponent.prototype.save = function () {
        ...
        if (this.computerPart.id != null) {
            this.http.put("api/computer-parts/" + this.computerPart.id, JSON.stringify(this.computerPart), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
        else {
            this.http.post('api/computer-parts', JSON.stringify(this.computerPart), { headers: headers }).subscribe(function (data) {
                _this.loadData();
            });
        }
        // } else {
    ...
    // }
    MainComponentComponent.prototype.editComputerPart = function (cpart) {
        this.computerPart = cpart;
    };
    MainComponentComponent.prototype.delete = function (id) {
        var _this = this;
        this.http.delete("/api/computer-parts/" + id).subscribe(function (res) {
            console.log("Obrisao" + ("" + id));
            _this.loadData();
        });
    };
    MainComponentComponent.prototype.addToShoppingCart = function (cPartItem) {
...
module.exports = __webpack_require__(/*! C:\Users\User\Documents\Projekti\ComputerShop\projekat\client\src\main.ts */"./src/main.ts");
